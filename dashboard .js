...
'Standings': `
  ...
  { rank: 3, team: "MSS-300", mp: 4, w: 2, d: 1, l: 1, gf: 20, ga: 14, gd: "+6", pts: 7 },

  { rank: 4, team: "CSC-300", mp: 5, w: 2, d: 1, l: 2, gf: 17, ga: 18, gd: "-1", pts: 7 },

  { rank: 5, team: "LAW-200", mp: 4, w: 2, d: 1, l: 1, gf: 17, ga: 23, gd: "-6", pts: 7 },

  { rank: 6, team: "CSC-100", mp: 5, w: 2, d: 0, l: 3, gf: 16, ga: 17, gd: "-1", pts: 6 },

  { rank: 7, team: "MSS-100", mp: 5, w: 2, d: 0, l: 3, gf: 14, ga: 18, gd: "-4", pts: 6 },

  { rank: 8, team: "CSC-200", mp: 5, w: 2, d: 0, l: 3, gf: 17, ga: 26, gd: "-9", pts: 6 },
...
function triggerStakeModal() {
    document.getElementById('stakeModal').classList.remove('hidden');
    document.getElementById('stakeModal').classList.add('flex');
}

function closeStakeModal() {
    document.getElementById('stakeModal').classList.remove('flex');
